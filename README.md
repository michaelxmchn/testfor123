...
[Demo](https://chat-gpt-next-web.vercel.app/) / [Issues](https://github.com/michaelxmchn/newgpt/issues) / [Join Discord](https://discord.gg/zrhvHCr79N) / [Buy Me a Coffee](https://www.buymeacoffee.com/)
...
- [x] System Prompt: pin a user defined prompt as system prompt [#138](https://github.com/michaelxmchn/newgpt/issues/138)
...
- [ ] Plugins: support network search, calculator, any other apis etc. [#165](https://github.com/michaelxmchn/newgpt/issues/165)
...
- [x] 为每个对话设置系统 Prompt [#138](https://github.com/michaelxmchn/newgpt/issues/138)
- [x] 允许用户自行编辑内置 Prompt 列表
- [ ] 提示词模板：使用预制上下文快速定制新对话
- [ ] 分享为图片，分享到 ShareGPT
- [ ] 使用 tauri 打包桌面应用
- [ ] 支持自部署的大语言模型
- [ ] 插件机制，支持联网搜索、计算器、调用其他平台 api [#165](https://github.com/michaelxmchn/newgpt/issues/165)
...
[Contributors](https://github.com/michaelxmchn/newgpt/graphs/contributors)
